import{_ as a,c as s,o as n,a3 as t}from"./chunks/framework.O95JGkcW.js";const k=JSON.parse('{"title":"asar文件","description":"","frontmatter":{"title":"asar文件"},"headers":[],"relativePath":"article/9、Electron/asar文件.md","filePath":"article/9、Electron/asar文件.md","lastUpdated":1723097831000}'),e={name:"article/9、Electron/asar文件.md"},i=t(`<h1 id="asar文件解压" tabindex="-1">asar文件解压 <a class="header-anchor" href="#asar文件解压" aria-label="Permalink to &quot;asar文件解压&quot;">​</a></h1><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"># 全局安装asar依赖</span></span>
