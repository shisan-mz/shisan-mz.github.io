import{_ as s,c as a,o as n,a3 as i}from"./chunks/framework.O95JGkcW.js";const o=JSON.parse('{"title":"git 常用命令","description":"","frontmatter":{"title":"git 常用命令"},"headers":[],"relativePath":"article/10、Git/git常用命令.md","filePath":"article/10、Git/git常用命令.md","lastUpdated":1714302060000}'),l={name:"article/10、Git/git常用命令.md"},p=i(`<h1 id="git-常用命令" tabindex="-1">git 常用命令 <a class="header-anchor" href="#git-常用命令" aria-label="Permalink to &quot;git 常用命令&quot;">​</a></h1><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"># 克隆</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">3</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">. 将删除操作提交至远程仓库（commit，push）</span></span></code></pre></div>`,2),t=[p];function e(h,E,k,g,c,r){return n(),a("div",null,t)}const y=s(l,[["render",e]]);export{o as __pageData,y as default};
