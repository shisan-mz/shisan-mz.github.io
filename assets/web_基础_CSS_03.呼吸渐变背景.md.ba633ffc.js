import{_ as s,o as n,c as a,V as l}from"./chunks/framework.5a3bb230.js";const i=JSON.parse('{"title":"呼吸渐变背景","description":"","frontmatter":{"title":"呼吸渐变背景"},"headers":[],"relativePath":"web/基础/CSS/03.呼吸渐变背景.md","filePath":"web/基础/CSS/03.呼吸渐变背景.md"}'),p={name:"web/基础/CSS/03.呼吸渐变背景.md"},o=l(`<h1 id="呼吸渐变背景" tabindex="-1">呼吸渐变背景 <a class="header-anchor" href="#呼吸渐变背景" aria-label="Permalink to &quot;呼吸渐变背景&quot;">​</a></h1><div class="language-html"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">&lt;!</span><span style="color:#F07178;">DOCTYPE</span><span style="color:#89DDFF;"> </span><span style="color:#C792EA;">html</span><span style="color:#89DDFF;">&gt;</span></span>
